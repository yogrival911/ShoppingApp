...
public class CircleProgressBarCustom extends View {
    ...
    public CircleProgressBarCustom(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        progressPaint.setColor(getResources().getColor(R.color.purple_500));
